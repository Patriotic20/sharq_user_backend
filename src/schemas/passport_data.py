...
class PersonalInfo(BaseModel):
    ...
    citizenship: str | None = Field(alias="citizenship")
    nationality: str | None = Field(alias="nationality")
    date_of_birth: date | None = Field(alias="birthDate")
    first_name: str = Field(alias="firstName")
    last_name: str = Field(alias="lastName")
    third_name: str | None = Field(alias="fatherName")
    ...
    district: str | None = Field(alias="district")
